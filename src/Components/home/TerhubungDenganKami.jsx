  ...
  return (
    <div className="container mx-auto py-12 text-center bg-gray-100">
      ...
      <div className="flex items-center justify-center gap-4">
        ...
        <h2 className="text-lg sm:text-2xl text-center font-bold text-gray-800">
      ...
      <div className="mt-8 flex max-sm:flex-col flex-wrap justify-center gap-8 sm:gap-20">
        {teamMembers.map((member, index) => (
          <div key={index} className="flex flex-col items-center">
            <img
              src={member.image}
              className="w-14 h-14 sm:w-24 sm:h-24 rounded-full border-2 border-black object-cover"
            />
            ...
            <a
              href={member.email}
              className="mt-2 text-black hover:text-yellow-500 transition"
            >
              <FaEnvelope size={20} />
            </a>
          </div>
